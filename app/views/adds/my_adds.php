    ...
    foreach($adds as $add){
     ...
     <li>
      ...
      <div class="Details">
        ...
        <div class="Ctrls">
        	<a href="<?php echo Request::root()?>/users/adds/update/<?php echo Crypt::encrypt($add->id)?>" title="Edit"><span class="glyphicon glyphicon-edit"></span></a>
            <a href="<?php echo Request::root()?>/users/adds/remove/<?php echo Crypt::encrypt($add->id)?>" title="Delete" class="add_del"><span class="glyphicon glyphicon-trash"></span></a>
